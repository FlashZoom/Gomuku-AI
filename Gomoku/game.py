...
class Game(object):
    ...
    def graphic(self, board, player1, player2,graphic):
        ...
        for i in range(height - 1, -1, -1):
            ...
            for j in range(width):
                ...
                if p == player1:
                    ...
                    graphic.white.append(loc)
                else:
                    print('_'.center(8), end='')
            print('\r\n\r\n')

    def start_play(self, player1, player2, graphic, start_player=0, is_shown=1):
        ...
        if is_shown:
            self.graphic(self.board, player1.player, player2.player, graphic)
        while True:
